"""
Django settings for DPHD project.
...
SECRET_KEY = 'django-insecure-^sac1e&0iy=+-$1f%z=-yqsm-zm5c#&l410l_z+5p+h$eo4i)4'
...
INSTALLED_APPS = [
    ...
    'DPHD.apps.helpdesk.apps.HelpdeskConfig'
]
...
WSGI_APPLICATION = 'DPHD.wsgi.application'
